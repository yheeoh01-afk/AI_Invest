...
# pykrx 호환성 보정: Python 3.14 / 최신 setuptools 환경에서 pkg_resources 오류 방지
try:
...
with st.expander("➕ 포트폴리오 추가/수정/삭제", expanded=False):
    ...
    if detail_source_df is None or detail_source_df.empty:
        st.info("포트폴리오에 종목을 추가하면 여기에서 종목별 기술분석·수급분석·뉴스를 볼 수 있습니다.")
    else:
